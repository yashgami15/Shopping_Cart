	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Times Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Times Electronics.<br>"
					...
					+ "<span class='greenText'>TIMES500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
