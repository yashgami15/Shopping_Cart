...
<body style="background-color: #D8BFD8;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold; padding-top:10px; padding-bottom:10px">Cart
		Items</div>
 ...
 -->
	...
	<div class="container">
		...
		<table class="table table-hover">
			<thead
				style="background-color: #880085; color: white; font-size: 16px; font-weight: bold;">
				<tr>
					<th>Picture</th>
					<th>Products</th>
					<th>Price</th>
