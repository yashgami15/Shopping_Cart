...
<body style="background-color: #D8BFD8;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold; padding-top:10px; padding-bottom:10px">Stock Products</div>
	<div class="container-fluid">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
					style="background-color: #51414F; color: white; font-size: 18px; ">
					<tr>
						<th>Image</th>
						<th>ProductId</th>
						<th>Name</th>
