...
<body style="background-color: #D8BFD8;">
 ...
 -->
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold; padding-top:10px; padding-bottom:10px">Order
		Details</div>
	...
	<div class="container">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
					style="background-color: #880085; color: white; font-size: 14px; font-weight: bold;">
					<tr>
						<th>Picture</th>
						<th>ProductName</th>
						<th>OrderId</th>
